...
kubectl set image deployments/client-deployment server=urdavid/multi-client:$SHA
kubectl set image deployments/worker-deployment server=urdavid/multi-worker:$SHA
